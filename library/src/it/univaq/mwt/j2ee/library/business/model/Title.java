...
public class Title implements java.io.Serializable {
	...
	public Title(String name, String author, String description, String isbn, int publicationYear, String editor, TitleKind titleKind) {
		this.name = name;
		this.author = author;
	...
	public Title(Long id, String name, String author, String description, String isbn, int publicationYear, String editor, TitleKind titleKind) {
